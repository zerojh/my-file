...
local endpoint_routegroup = uci:get_all("endpoint_routegroup") or {}
...
for i=1,MAX_ROUTEGRP do
	for k,v in pairs(endpoint_routegroup) do
		if v.index and tonumber(v.index) == i and v.name then
...
for i=1,MAX_MANIPL_PROFILE do
	for _,v in pairs(profile_manipl) do
