...
<%-
	...
	--self.s1_keylist = {"Deactivate","1003","1004","SIPP-1","SIPP-2","SIPP-3","SIPP-4","SIPP-5","SIPP-6","SIPP-7"}
	--self.s1_vallist = {translate("Off"),"1003","1004","SIPP-1","SIPP-2","SIPP-3","SIPP-4","SIPP-5","SIPP-6","SIPP-7"}
	--self.s2_keylist = {"","1","2","3","addnew_profile_time/extension-sip-cfg18aa11-edit"}
	--self.s2_vallist = {translate("Alaway"),"1","2","3",translate("< Add New ...>")}
	--self.id_keylist = {"SIPP-1","SIPP-2","SIPP-3","SIPP-4","SIPP-5","SIPP-6","SIPP-7"}
...
function cbi_callforwarding_init(name, respath, input_depends)
{
	...
	for (var i = 0; i < selobjs.length; i++) {
		...
		cbi_callforwarding_whole_update(c6);
