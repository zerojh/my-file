...
local config = {
	["profile_sip"] = {
		...
		["bypass_media"]="Bypass Media(SIP to SIP)",
	...
	["profile_fxso"] = {
		...
		["flashhook_dtmf"]="Send Flash Hook via SIP INFO / RFC2833",
		...
		["offhook_current_threshold"]="Offhook Current Detect Threshold",
		["onhook_current_threshold"]="Onhook Current Detect Threshold",
	},
	["profile_codec"] = {
		["index"]="Index",
		["name"]="Name",
	...
	["firewall"]={
		...
		["enabled_url_filter"]="Filter Rules Control",
		["__enabled_url_filter_value"]={
			["0"]="Off",
			["1"]="On",
		},
		["disable_url_blacklist"]="Default Filter Type",
		["__disable_url_blacklist_value"]={
			["0"]="Black List",
			["1"]="White List",
		},
		["forward"]="Default action outside the filter rules",
		["index"]="Index",
		["name"]="Name",
		["src_dport"]="WAN Port",
		["proto"]="Protocol",
		...
		["src_ip"]="LAN IP",
		["nat_src_ip"]="Internal Address",
		["url_src_ip"]="IP Address",
		["src_port"]="LAN Port",
		["dest_ip"]="WAN IP",
		["port_mapping_dest_ip"]="LAN IP",
		["port_mapping_dest_port"]="LAN Port",
		["dmz_dest_ip"]="DMZ IP Address",
		["dmz_enabled"]="DMZ Status",
		["nat_dest_ip"]="Internal Address",
		["src_dip"]="External Address",
		["description"]="Description",
		["dest_port"]="WAN Port",
		["src"]="Source",
		["dest"]="Dest",
		["defaults_enabled"]="Filter Rules Control",
		["__defaults_value"]={
			["0"]="Off",
			["1"]="On",
		},
		...
		["target"]="Action",
		["Allow-Ping_target"]="Response Of Ping Request",
		["ftype"]="Filter Type",
		["__ftype_value"]={
			["url"]="URL",
		...
		["url"]="Keyword",
		["weekdays"]="Effective Time",
		["timestart"]="Effective Time",
		["timestop"]="Effective Time",
		["whitelist"]="Default Filter Type",
		["__whitelist_value"]={
			["0"]="Black List",
			["1"]="White List",
		},
	...
	["gre"] = {
		["default_enabled"]="Gre Service Status",
		["enabled"]="Status",
		["__enabled_value"]={
			["0"]="Disabled",
			["1"]="Enabled",
		},
		["interface"]="Tunnel Interface Index",
		["ipaddr"]="IP Address / Netmask",
		["iface"]="Tunnel Source Interface",
		["__iface_value"]={
			["wan"]="WAN",
		},
		["remote"]="Tunnel Destination Address",
	},
	["ipsec"] = {
		["index"]="Index",
		["enabled"]="Status",
		["l2tp_enabled"]="Tunnel Authentication",
		["__enabled_value"]={
			["0"]="Disabled",
			["1"]="Enabled",
		},
		["interface"]="Local Tunnel Interface",
		["remote"]="Remote Tunnel IP",
		["net2net_remote"]="Remote Tunnel Address",
		["password"]="Shared Key",
		["l2tp_password"]="Authentication Password",
		["ike_encryption"]="Encryption",
		["ike_hash"]="AUTH",
		["ike_dhgroup"]="DH Group Key",
		["esp_encryption"]="Encryption",
		["esp_auth"]="AUTH",
		["esp_dhgroup"]="PFS",
		["flag_advanced"]="Advanced",
		["ikelifetime"]="IKE Life Time(H)",
		["keylife"]="Key Life(H)",
		["dpddelay"]="DPD Delay(S)",
		["dpdtimeout"]="DPD Timeout(S)",
	...
	["network"] = {
		...
		["name"]="Interface Name",
		["metric"]="Metric",
		["bindinglan"]="Binding Ports",
		["type"]="Network Mode",
		["switch_vlan_id"]="Switch Vlan ID",
		["ifname"]="Ifname",
		["device"]="Device",
		["ports"]="Ports",
		["valid"]="Valid",
		["vid"]="VLANID",
		["vlan"]="Vlan",
		["tmp_vlanipaddr"]="Vlan Ipaddr",
		["vlan_sub_link"]="Vlan Sub Link",
		["wan_sub_link"]="Wan Sub Link",
		["lookup"]="Lookup",
		["src"]="Src",
		["apn"]="APN",
		...
		["description"]="Description",
		["wan_switch"]="WAN Physical interface",
		["__wan_switch_value"]={
			["on"]="GPON",
			["off"]="GE",
		},
	...
	["mwan3"] = {
		...
		["dest_ip"]="Dest IP",
		["dest_port"]="Dest Port",
		["use_policy"]="Interface",
		["__use_policy_value"]={
			["m_wan"]="WAN",
		},
		["metric"]="Uplink Strategy",
		["__metric_value"]={
			["0"]="WAN Master,LTE Slave",
			["1"]="LTE Master,WAN Slave",
		},
		["track_ip"]="Track IP",
		["count"]="Ping Count",
		["timeout"]="Timeout(s)",
	...
	["portal"] = {
		...
		["authtype"]="Auth Type",
		["timeout"]="Timeout(m)",
		["ipauth"]="Binding User IP",
		["__ipauth_value"]={
			["0"]="Disabled",
			["1"]="Enabled",
		},
		["macauth"]="Binding User MAC",
		["__macauth_value"]={
			["0"]="Disabled",
			["1"]="Enabled",
		},
	...
	["qos"] = {
		["setup_enabled"]="Qos Service Status",
		["enabled"]="Status",
		["__enabled_value"]={
			["0"]="Disabled",
			["1"]="Enabled",
		...
		["__model_value"]={
			...
			["spq"]="SPQ",
			["drr_spq"]="SPQ+DRR",
			["remark_only"]="Remark Only",
		},
		["setup_direct"]="Qos Direction",
		["__setup_direct_value"]={
			["upload"]="Upload",
			["download"]="Download",
			["bidirection"]="Bidirection",
		},
		["up_bandwith"]="Upload Bandwith(Mbits)",
		["down_bandwith"]="Download Bandwith(Mbits)",
		["down_low_rate"]="low:Download Rate(%)",
		["down_low_ceil"]="low:Download Ceil(%)",
		["up_low_rate"]="low:Upload Rate(%)",
		["up_low_ceil"]="low:Upload Ceil(%)",
		["down_default_rate"]="default:Download Rate(%)",
		["down_default_ceil"]="default:Download Ceil(%)",
		["up_default_rate"]="default:Upload Rate(%)",
		["up_default_ceil"]="default:Upload Ceil(%)",
		["down_high_rate"]="high:Download Rate(%)",
		["down_high_ceil"]="high:Download Ceil(%)",
		["up_high_rate"]="high:Upload Rate(%)",
		["up_high_ceil"]="high:Upload Ceil(%)",
		["down_highest_rate"]="highest:Download Rate(%)",
		["down_highest_ceil"]="highest:Download Ceil(%)",
		["up_highest_rate"]="highest:Upload Rate(%)",
		["up_highest_ceil"]="highest:Upload Ceil(%)",
		["index"]="Index",
		...
		["__direct_value"]={
			["down"]="Download",
			["up"]="Upload",
			["up_down"]="Bidirectional",
		},
		["target"]="Queue",
		["remark_dscp"]="DSCP Remark",
	},
	["wireless"] = {
	...
	["attack"] = {
		["enabled_log"]="Attack Log",
		["__enabled_log_value"]={
			["0"]="Off",
			["1"]="On",
		},
		["ping_of_death_enabled"]="ICMP-Flood Attack Defense",
		["udp_flood_enabled"]="UDP-Flood Attack Defense",
		["tcp_null_enabled"]="TCP-NULL Attack Defense",
		["tcp_xmas_tree_enabled"]="TCP XMAS TREE Attack Defense",
		["tcp_flood_enabled"]="TCP-Flood Attack Defense",
		["__enabled_value"]={
			["0"]="Disabled",
			["1"]="Enabled",
		},
...
function get_ip_netmask(param)
	local netmask=""
	local ip,num=param:match("^([0-9%.]+)/([0-9]+)$")
	if num ~= "" then
		netmask=tostring(luci.ip.prefix2netmask(num))
	end
	return ip.."/"..netmask
end

function get_pptdp_addr(param)
	local start_ip,end_ip=param:match("^([0-9%.]+)-([0-9]+)$")
	end_ip=start_ip:match("^([0-9]+%.[0-9]+%.[0-9]+%.)[0-9]+$")..end_ip
...
function parse_dhcp_server_value(option,value)
	...
	elseif "dhcp_option" == option then
		if value:match("^3,") then
			return translate("Gateway").." : "..value:match("^3,([0-9%.]+)")
		elseif value:match("^6,") then
			return translate("DNS").." : "..value:match("^6,([0-9%.%,]+)")
		else
			return ""
		end
	end
...
function get_config_name(cfg_name,section,option)
	if section then
		...
		for k,v in pairs(t) do
			if k == section or v[".name"] == section then
				...
				elseif "provision" == cfg_name or "cloud" == cfg_name or ("dhcp" == cfg_name and "lan" == section) or "ddns" == cfg_name or "upnpc" == cfg_name then
					return translate(config_file[cfg_name])
				elseif "wireless" == cfg_name and (("ra0" == section and v.wdsmode) or ("wifi-iface" == v[".type"] and v.wdsphymode)) then 
					return translate("WLAN Config")
				elseif "openvpn" == cfg_name then
					return translate("OpenVPN Client")
				elseif "xl2tpd" == cfg_name and "l2tpd" == section then
					return translate("L2TP Server").." / "..translate("General")
				elseif "ipsec" == cfg_name and "l2tp" == v[".type"] then
					return translate("L2TP Server")
				elseif "xl2tpd" == cfg_name and "main" == section then
					return translate("L2TP Client").." / "..translate("General")
				elseif "pptpd" == cfg_name and "pptpd" == section then
					return translate("PPTP Server").." / "..translate("General")
				elseif "firewall" == cfg_name and "dmz" == v[".name"] then
					return translate("DMZ Setting")
				elseif "firewall" == cfg_name and "redirect" == v[".type"] and (v.name and ((v.name:match("^SNAT.+$") or v.name:match("^DNAT.+$"))) or (not v.name and v.enabled)) then
					return "NAT"
				elseif "firewall" == cfg_name and "redirect" == v[".type"] and v.name then
					return translate("Port Mapping").." / "..v.name
				elseif "firewall" == cfg_name and "url" == v[".type"] then
					return translate("URL Filter")
				elseif "firewall" == cfg_name and "rule" == v[".type"] and "Allow-Ping" == v.name then
					return translate("Attack Defense")
				elseif "firewall" == cfg_name and "filter" == v[".type"] then
					return translate("MAC Filter")
				elseif "firewall" == cfg_name and "defaults" == section and ("enabled_url_filter" == option or "disable_url_blacklist" == option) then
					return translate("URL Filter").." / "..section
				elseif "network" == cfg_name and "wan" == section then
					return translate("WAN")
				elseif "network" == cfg_name and "lan" == section then
					return translate("LAN Config")
				elseif "network" == cfg_name and "switch_port" == v[".type"] then
					return translate("Port Config").." / "..v.port
				elseif "network" == cfg_name and "wan2" == section then
					return translate("LTE")
				elseif "network" == cfg_name and "route" == v[".type"] then
					return translate("Static Route").." / "..v.index
				elseif "network" == cfg_name and ("switch_vlan" == v[".type"] or ("interface" == v[".type"] and section:match("^vlan"))) then
					return translate("VLAN Config")
				elseif "network" == cfg_name and (("rule" == v[".type"] and v.lookup and v.src) or ("interface" == v[".type"] and v.bindinglan)) then
					return translate("WAN Subinterface Config")
				elseif "mwan3" == cfg_name and "rule" == v[".type"] then
					return translate("Policy Route")
				...
				elseif "dhcp" == cfg_name and (("host" == v[".type"] and "static_ipmacarp" == v.name) or  ("static_arp" == v[".type"])) then
					return translate("ARP Protect")
				elseif "dhcp" == cfg_name and "host" == v[".type"] then
					return translate("Static IP Addressing")
				elseif "dhcp" == cfg_name and "dhcp" == v[".type"] then
					return translate("DHCP Server").." / "..v.index
				elseif "domainlist_tmp" == cfg_name then
					return translate("Auto VPN")
				elseif "autovpn" == cfg_name then
					return translate("Auto VPN").." / "..translate("General")
				elseif v.name then
...
function get_config_option_name(cfg_name,section,option)
	if "network" == cfg_name and "wan" == section and "gateway" == option then
		return translate(config["network"] and config["network"]["wan_"..option] or option)
	elseif "network" == cfg_name and "wan2" == section and "disabled" == option then
		return translate(config["network"] and config["network"]["lte_"..option] or option)
	elseif "firewall" == cfg_name and "defaults" == section and "enabled" == option then
		return translate(config["firewall"] and config["firewall"]["defaults_"..option] or option)
	elseif "attack" == cfg_name and section and "enabled" == option then
		return translate(config[cfg_name] and config[cfg_name][section.."_"..option] or option)
	elseif "qos" == cfg_name and "setup" == section and ("direct" == option or "enabled" == option) then
		return translate(config[cfg_name] and config[cfg_name]["setup_"..option] or option)
	elseif "pptpd" == cfg_name and "pptpd" == section and "remoteip" == option then
		return translate("Client Start Address").." / "..translate("Client End Address")
	elseif "gre" == cfg_name and "enabled" == option then
		for k,v in pairs(uci:get_all(cfg_name)) do
			if section == k and "default" == v[".type"] then
				return translate(config[cfg_name] and config[cfg_name]["default_"..option] or option)
			end
		end
	elseif "ipsec" == cfg_name and ("enabled" == option or "password" == option or "local_subnet" == option or "remote" == option or "remote_subnet" == option) then
		for k,v in pairs(uci:get_all(cfg_name)) do
			if section == k and "l2tp" == v[".type"] then
				return translate(config[cfg_name] and config[cfg_name]["l2tp_"..option] or option)
			end
			if section == k and ("roadwarrior" == v[".type"] or "net2net" == v[".type"]) and "local_subnet" == option then
				return translate("Local Subnet Address").." / "..translate("Local Subnet Mask")
			end
			if section == k and "net2net" == v[".type"] and "remote_subnet" == option then
				return translate("Remote Subnet Address").." / "..translate("Remote Subnet Mask")
			end
			if section == k and "net2net" == v[".type"] and "remote" == option then
				return translate(config[cfg_name] and config[cfg_name]["net2net_"..option] or option)
			end
		end
	elseif "wireless" == cfg_name and "ra0" == section and "disabled" == option then
		return translate(config[cfg_name] and config[cfg_name]["ra_"..option] or option)
	elseif "firewall" == cfg_name and "dmz" == section and ("enabled" == option or "dest_ip" == option) then
		return translate(config[cfg_name] and config[cfg_name]["dmz_"..option] or option)
	elseif "firewall" == cfg_name then
		for k,v in pairs(uci:get_all(cfg_name)) do
			if k == section and "url" == v[".type"] and "src_ip" == option then
				return translate(config[cfg_name] and config[cfg_name]["url_"..option] or option)
			elseif k == section and "rule" == v[".type"] and "Allow-Ping" == v.name and "target" == option then
				return translate(config[cfg_name] and config[cfg_name]["Allow-Ping_"..option] or option)
			elseif k == section and "redirect" == v[".type"] and v.name and (v.name:match("^SNAT.+$") or v.name:match("^DNAT.+$")) and ("src_ip" == option or "dest_ip" == option) then
				return translate(config[cfg_name] and config[cfg_name]["nat_"..option] or option)
			elseif k == section and "redirect" == v[".type"] and ("dest_port" == option or "dest_ip" == option) then
				return translate(config[cfg_name] and config[cfg_name]["port_mapping_"..option] or option)
			end
		end
	end
...
function get_config_option_value(cfg_name,section,option,value)
	if ("wireless" == cfg_name and "ra0" == section and "wps" == option) or ("network" == cfg_name and "wan" == section and "wan_switch" == option) then
	...
	elseif "true" == value or "on" == value or "Activate" == value then
		return translate("On")
	...
	elseif "gre" == cfg_name and "ipaddr" == option and value then
		return get_ip_netmask(value)
	elseif "ipsec" == cfg_name and ("local_subnet" == option or "remote_subnet" == option) and value then
		return get_ip_netmask(value)
	elseif "pptpd" == cfg_name and "pptpd" == section and "remoteip" == option then
		return get_pptdp_addr(value)
	...
	elseif "qos" == cfg_name and "setup" == section and "direct" == option then
		return translate(config["qos"] and config["qos"]["__setup_"..option.."_value"] and config["qos"]["__setup_"..option.."_value"][value] or value)
	elseif "route" == cfg_name and ("custom_from" == option or "from" == option) and "-1" ~= value and "0" ~= value then
		return get_endpoint_name(value,"from")
	elseif "route" == cfg_name and ("successDestination" == option or "failDestination" == option) and "-1" ~= value and "0" ~= value then
		return get_endpoint_name(value)
