...
function sync_user_to_system(is_restore)
	...
	for k,v in ipairs(passwd_file_user_tb) do
		if "root" ~= v and "daemon" ~= v and "ftp" ~= v and "network" ~= v and "nobody" ~= v and "admin" ~= v and "homeultera" ~= v and "" ~= v then
	...
	for k,v in pairs(user_list) do
		if "user" == v[".type"] and v.name and "root" ~= v.name and "daemon" ~= v.name and "ftp" ~= v.name and "network" ~= v.name and "nobody" ~= v.name and "admin" ~= v.name and "homeultera" ~= v.name then
