...
local config = {
	...
	["profile_fxso"] = {
		...
		["busy_tone_on"]="On Time(ms)",
		["busy_tone_off"]="Off Time(ms)"
	},
	["profile_codec"] = {
		["index"]="Index",
		["name"]="Name",
	...
	["wireless"]={
		...
		["isolate"]="WIFI Isolate",
		["__isolate_value"]={
			["0"]="On",
			["1"]="Off",
		},
		["txpower"]="WIFI Tx Power",
		["wps"]="WPS",
		["__wps_value"]={
			["0"]="On",
			["1"]="Off",
		...
		["ssid"]="SSID",
		["wdskey"]="Remote WIFI Password",
		["wdsencryptype"]="Remote WIFI Encryption",
		...
		["wdsphymode"]="Remote WIFI Phymode",
		["wdspeermac"]="Remote WIFI Macaddr",
	},
}
