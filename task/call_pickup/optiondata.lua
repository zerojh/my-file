...
local config = {
	...
	["profile_sip"] = {
		...
		["progress_timeout"]="Progress Timeout(s)",
		["dtmf"]="DTMF Type",
		["__dtmf_value"]={
			["info"]="SIP INFO",
			["rfc2833"]="RFC2833",
		...
		["suppress_cng"]="CNG(Comfort Noise Generator)",
		["__suppress_cng_value"] = {
			["1"]="Off",
			["0"]="On",
		},
	...
	["profile_fxso"] = {
		...
		["ringtimeout"]="Call Out Ring Timeout(s)",
		["noanswer"]="Call In No Answer Timeout(s)",
	...
	["endpoint_sipphone"] = {
		...
		["callin_filter"]="Call In Filter",
		["__callin_filter_value"]={
			["off"]="Off",
			["blacklist"]="Black List",
			["whitelist"]="White List",
		},
		["callin_filter_blacklist"]="Call In Black List",
		["callin_filter_whitelist"]="Call In White List",
		["callout_filter"]="Call Out Filter",
		["__callout_filter_value"]={
			["off"]="Off",
			["blacklist"]="Black List",
			["whitelist"]="White List",
		},
		["callout_filter_blacklist"]="Call Out Black List",
		["callout_filter_whitelist"]="Call Out White List",
		["profile"]="SIP Profile",
		["status"]="Status",
	...
	["endpoint_fxso"] = {
		...
		["slic_hy_1"]="Transhybrid Balancing Param",
		...
		["callin_filter_1"]="Call In Filter",
		["__callin_filter_1_value"]={
			["off"]="Off",
			["blacklist"]="Black List",
			["whitelist"]="White List",
		},
		["callin_filter_blacklist_1"]="Call In Black List",
		["callin_filter_whitelist_1"]="Call In White List",
		["callout_filter_1"]="Call Out Filter",
		["__callout_filter_1_value"]={
			["off"]="Off",
			["blacklist"]="Black List",
			["whitelist"]="White List",
		},
		["callout_filter_blacklist_1"]="Call Out Black List",
		["callout_filter_whitelist_1"]="Call Out White List",
		["call_pickup_1"]="Call Pickup",
		["__call_pickup_1_value"]={
			["off"]="Off",
			["ringgrp"]="Ring Group",
			["extension"]="Local Extension",
		},
		...
		["slic_hy_2"]="Transhybrid Balancing Param",
		...
		["callin_filter_2"]="Call In Filter",
		["__callin_filter_2_value"]={
			["off"]="Off",
			["blacklist"]="Black List",
			["whitelist"]="White List",
		},
		["callin_filter_blacklist_2"]="Call In Black List",
		["callin_filter_whitelist_2"]="Call In White List",
		["callout_filter_2"]="Call Out Filter",
		["__callout_filter_2_value"]={
			["off"]="Off",
			["blacklist"]="Black List",
			["whitelist"]="White List",
		},
		["callout_filter_blacklist_2"]="Call Out Black List",
		["callout_filter_whitelist_2"]="Call Out White List",
		["call_pickup_2"]="Call Pickup",
		["__call_pickup_2_value"]={
			["off"]="Off",
			["ringgrp"]="Ring Group",
			["extension"]="Local Extension",
		},
	...
	["user"]={
		...
		["description"]="Description",
		["status"]="Status",
		["status_sipstatus"]="Status / SIP",
		["status_pstnstatus"]="Status / PSTN",
		["status_client_list"]="Status / DHCP Client List",
		["status_vpn"]="Status / VPN",
		["status_wifi"]="Status / Wireless AP List",
		["status_currentcall"]="Status / Current Call",
		["status_cdr"]="Status / CDRs",
		["status_service"]="Status / Service",
		["status_about"]="Status / About",
		["system"]="System",
		["system_setting"]="System / Setting",
		["system_security"]="System / User Manager",
		["system_provision"]="System / Provision",
		["system_operationlog"]="System / Operation Log",
		["system_servicelog"]="System / Service Log",
		["system_changeslog"]="System / Config Changes Log",
		["system_backup_upgrade"]="System / Backup/Restore/Upgrade",
		["system_voice"]="System / Voice",
		["system_cmd"]="System / Command Line",
		["system_tr069"]="System / TR069",
		["system_cloud"]="System / Cloud Service",
		["system_reboot"]="System / Reboot",
		["system_gsm_tools"]="System / GSM Tools",
		["system_diagnostics"]="System / Diagnostics",
		["network"]="Network",
		["network_setting"]="Network / Setting",
		["network_access_control"]="Network / Access Control",
		["network_firewall"]="Network / Firewall",
		["network_dhcp_server"]="Network / DHCP Server",
		["network_port_map"]="Network / Port Mapping",
		["network_dmz"]="Network / DMZ Setting",
		["network_diagnostics"]="Network / Diagnostics",
		["network_ddns"]="Network / DDNS",
		["network_static_route"]="Network / Static Route",
		["network_upnpc"]="Network / UPnP Client",
		["network_vpn"]="Network / VPN Client",
		["network_hosts"]="Network / Hosts",
		["network_lte"]="Network / LTE",
		["network_uplink"]="Network / Uplink Config",
		["profile"]="Profile",
		["profile_sip"]="Profile / SIP",
		["profile_codec"]="Profile / Codec",
		["profile_number"]="Profile / Number",
		["profile_time"]="Profile / Time",
		["profile_manipl"]="Profile / Manipulation",
		["profile_dialplan"]="Profile / Dialplan",
		["profile_fxso"]="Profile / FXS/FXO",
		["profile_fxso"]="Profile / FXS",
		["profile_fxso"]="Profile / FXO",
		["profile_numberlearning"]="Profile / SIM Number Learning",
		["extension"]="Extension",
		["extension_sip"]="Extension / SIP",
		["extension_ringgroup"]="Extension / Ring Group",
		["extension_fxs"]="Extension / FXS",
		["trunk"]="Trunk",
		["trunk_sip"]="Trunk / SIP",
		["trunk_fxo"]="Trunk / FXO",
		["trunk_mobile"]="Trunk / GSM",
		["callcontrol"]="Call Control",
		["callcontrol_setting"]="Call Control / Setting",
		["callcontrol_routegroup"]="Call Control / Route Group",
		["callcontrol_route"]="Call Control / Route",
		["callcontrol_featureCode"]="Call Control / Feature Code",
		["callcontrol_ivr"]="Call Control / IVR",
		["callcontrol_sms"]="Call Control / SMS",
		["callcontrol_ussd"]="Call Control / USSD",
...
function get_endpoint_name(value,dest_type)
	...
	if value:match("^GSM%-%d+$") or value:match("^gsmopen/%d+%-GSM") then
		return translate("GSM Trunk")
	elseif value:match("^VOLTE%-%d+$") or value:match("^gsmopen/%d+%-VOLTE") then
		return translate("VoLTE Trunk")
	end
...
function get_ivr_dest(name)
	...
	if desttype and param then
		if "Extensions" == desttype then
			...
			return translate("FXS Extension").." / "..param
		elseif "Trunks" == desttype then
			...
			elseif param:match("^gsmopen/%d+%-GSM") then
				return translate("GSM Trunk")
			elseif param:match("^gsmopen/%d+%-VOLTE") then
				return translate("VoLTE Trunk")
			else
		...
		for k,v in pairs(j) do
			...
			for kk,vv in util.kspairs(v) do
				if kk:sub(1,1) ~= "." then
					...
					if ("1"==port or not port) and port_map[k]["1"] and ((interface:match("S") and port_map[k]["type"] == "fxs") or (interface:match("2O") and port_map[k]["type"] == "fxo")) then
						if #port_1_s == 0 then
					...
					if ("2"==port or not port) and port_map[k]["2"] and ((interface:match("2S") and port_map[k]["type"] == "fxs") or (interface:match("O") and port_map[k]["type"] == "fxo")) then
						if #port_2_s == 0 then
							if "fxs" == port_map[k]["type"] then
		...
		for k,v in pairs(t) do
			if k == section or v[".name"] == section then
				...
				elseif "mwan3" == cfg_name and ("wan2" == section or "wan2_m2_w2" == section) then
					if luci.version.license and luci.version.license.volte then
						return translate("Uplink Config").." / VoLTE"
					else
				...
				elseif "user" == cfg_name then
					if v[".type"] == "user" then
						return translate("User Manager").." / "..(v[".name"] or v.name or "")
					else
						return translate("User Manager").." / "..translate("Web Access Permission").." / "..(v[".name"] and (v[".name"]:match("(.+)_web$") or "") or "")
					end
				elseif "endpoint_mobile" == cfg_name then
					if "LTE" == v.name then
						return "LTE"
					elseif "VOLTE" == v.name then
						return "VoLTE"
					else
						return translate("GSM Trunk")
					end
				elseif "lte" == cfg_name then
					if luci.version.license and luci.version.license.volte then
						return "VoLTE"
					else
						return "LTE"
...
function get_config_option_name(cfg_name,section,option)
	...
	elseif "user" == cfg_name and luci.version.license and luci.version.license.volte then
		if "trunk_mobile" == option then
			return translate("Trunk / VoLTE")
		elseif "network_lte" == option then
			return translate("Network / VoLTE")
		else
...
function get_config_option_value(cfg_name,section,option,value)
	...
	elseif "route" == cfg_name and ("custom_from" == option or "from" == option or "successDestination" == option or "failDestination" == option) and value and value > '0' then
		if "custom_from" == option or "from" == option then
	...
	elseif "user" == cfg_name and ("view" == value or "view,edit" == value or "edit,view" == value) then
		if "view" == value then
			return translate("View")
		else
			return translate("View,Edit")
		end
	elseif "endpoint_mobile" == cfg_name and luci.version.license and luci.version.license.volte then
		if "bandtype" == option then
			local tmp_tb = {["0"]="All",["1"]="VoLTE 900",["2"]="VoLTE 1800",["3"]="VoLTE 1900",["4"]="VoLTE 900 & VoLTE 1800",["5"]="VoLTE 850 & VoLTE 1900"}
			return tmp_tb[value] or "Unknown"
		else
	...
	elseif "static_route" == cfg_name and luci.version.license and luci.version.license.volte then
		if "wan2" == value then
			return "VoLTE"
		else
			return translate(config[cfg_name] and config[cfg_name]["__"..option.."_value"] and config[cfg_name]["__"..option.."_value"][value] or value)
