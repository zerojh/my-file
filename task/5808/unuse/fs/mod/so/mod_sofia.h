...
typedef enum {
	...
	PFLAG_PROXY_REFER,
	PFLAG_DESTNUMBER_SIP_REQUEST_URL,
	PFLAG_DESTNUMBER_SIP_TO,
	PFLAG_CALLERNUMBER_FROM_DISPLAY,
	PFLAG_CALLERNUMBER_FROM_USER,
	PFLAG_ALLOW_UNKNOWN_CALL,
...
#define SOFIA_MAX_MSG_QUEUE 4
#define SOFIA_MSG_QUEUE_SIZE 128
...
#define sofia_reg_find_gateway_by_addr(x) sofia_reg_find_gateway_by_addr__(__FILE__, __SWITCH_FUNC__, __LINE__,  x)
...
#define sofia_reg_find_gateway_by_realm_profile(x,y) sofia_reg_find_gateway_by_realm_profile__(__FILE__, __SWITCH_FUNC__, __LINE__,  x,y)
...
#define sofia_reg_find_gateway_by_realm_profile_user(x,y,z) sofia_reg_find_gateway_by_realm_profile_user__(__FILE__, __SWITCH_FUNC__, __LINE__,  x,y,z)
