...
/* Note that the speed of the motor is adjusted for the lendgth of the rotary arm */
...
void MotorProxy_writeMotorSpeed(MotorProxy* const me, const DirectionType* dirction, unsigned int speed);
