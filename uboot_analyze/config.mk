...
# $(filter-out -pedantic,$(HOSTCFLAGS)) 从HOSTCFLAGS中除去-pedantic
...
#
# CC_OPTIONS_CACHE_FILE := $(CURDIR)/include/generated/cc_options.mk
# CC_TEST_OFILE := $(CURDIR)/include/generated/cc_test_file.o
...
# CPU-specific code.
# CPU_DIR=arch/arm/cpu/arm1176
CPUDIR=arch/$(ARCH)/cpu/$(CPU)
ifneq ($(SRCTREE)/$(CPUDIR),$(wildcard $(SRCTREE)/$(CPUDIR)))
CPUDIR=arch/$(ARCH)/cpu
endif

# $(CURDIR)/arch/arm/config.mk 里定义CROSS_COMPILE = arm-linux-
...
# 加代码起始地址，在board/samsung/smdk6400/config.mk中定义
ifneq ($(CONFIG_SYS_TEXT_BASE),)
